        ...
        public static class Logger
        {
            public static void WriteToLog(string message)
            {
                try
                {
                    ...
                    {
                        str = "_______________________________________" + swriter.NewLine + DateTime.Now.ToString("dd.MM.yyyy HH:mm:ss") + " " + message + swriter.NewLine + str; //"example text" + Environment.NewLine + str;
                        swriter.Write(str);
                    }
                }
                catch (Exception)
            ...
            public static void WriteToLog(string[] messages)
            {
                try
                {
                    StreamWriter outfile = new StreamWriter("" + AppDomain.CurrentDomain.BaseDirectory + @"/log/" + DateTime.Today.ToString("yyyy-MM-dd_HH") + ".log", true);
                    {
                        ...
                        outfile.Write(DateTime.Now.ToString("dd.MM.yyyy HH:mm:ss"));
