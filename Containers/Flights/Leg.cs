...
namespace TopTourMiddleOffice.Containers.Flights
{
    //перелет
    public class Leg
    {
        ...
        {
            get { return _departureTime.ToString("dd.MM.yyyy HH:mm:ss"); }
            set { }
        }
        ...
        {
            get { return _arrivalTime.ToString("dd.MM.yyyy HH:mm:ss"); }
            set { }
        }
