    ...
    public class TuristContainer
    {
        ...
        public TuristContainer(JsonObject inp)
        {
            try
            {
                ...
                _birthDate = DateTime.ParseExact(inp["birth_date"].ToString(), "dd.MM.yyyy", null);
                ...
                _passportDate = DateTime.ParseExact(inp["passport_date"].ToString(), "dd.MM.yyyy", null);// new DateTime((int)turistPd[0], (int)turistPd[1], (int)turistPd[2]);
        ...
        {
            get { return _passportDate.ToString("dd.MM.yyyy"); }
            set { }
        }
    }
}