...
namespace TopTourMiddleOffice.Responses
{
    public class DogovorInfo
    {
        ...
        */
        ...
        {
            get { return this._tourDate.ToString("dd.MM.yyyy"); }
            set { }
        }
        ...
        {
            get { return this._payDate.ToString("dd.MM.yyyy HH:mm:ss zzz"); }
            set { }
        }
        ...
        {
            get { return this._upDate.ToString("dd.MM.yyyy HH:mm:ss zzz"); }
            set { }
        }
